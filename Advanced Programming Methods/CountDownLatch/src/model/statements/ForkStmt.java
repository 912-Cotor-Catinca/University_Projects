...
public class ForkStmt implements IStmt {
    ...
    public PrgState execute(PrgState state) throws MyException {
        ...
        stack.push(stmt);
        PrgState newPrgState = new PrgState(stack, newSymTable, state.getFileTable(), state.getHeapTable(), state.getOut(), state.getLockTable(), state.getSemaphore(), state.getLatchTable(), state.getBarrier(), state.getToySem());
        newPrgState.setID();
        return newPrgState;
    }
