...
public class PrgState {
    ...
    public PrgState(IStack<IStmt> exeStack, IDict<String, IValue> symTable, IDict<StringValue, BufferedReader> fileTable, IHeap<IValue> heapTable, IList<String> out,
                     ISemaphore semaphore, IStmt originalProgram) {
    ...
    public PrgState(IStack<IStmt> exeStack, IDict<String, IValue> symTable, IDict<StringValue, BufferedReader> fileTable, IHeap<IValue> heapTable, IList<String> out, ISemaphore semaphore) {
        this.exeStack = exeStack;
        this.symTable = symTable;
        this.out = out;
        this.heapTable = heapTable;
