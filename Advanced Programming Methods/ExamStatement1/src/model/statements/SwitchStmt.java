...
public class SwitchStmt implements IStmt{
    ...
    public IDict<String, IType> typeCheck(IDict<String, IType> typeEnv) throws Exception {
        IType exp1_type = exp.typeCheck(typeEnv);
        IType exp2_type = exp1.typeCheck(typeEnv);
        IType exp3_type = exp2.typeCheck(typeEnv);
        if(exp1_type.equals(exp3_type) && exp1_type.equals(exp2_type)){
